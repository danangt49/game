...
<?php $__env->startSection('content'); ?>
    <div class="col-md-6">
        <a href="<?php echo e(url('admin/matches-create')); ?>" class="btn btn-primary"><i class="fas fa-plus-square"> ADD</i></a>
    </div>
    <hr>
    ...
    <script>
        $(document).ready( function () {
            $('#laravel_datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(url('admin/JSONmatches')); ?>",
                columns: [
        ...
        $('body').on('click', '.delete', function () {
            ...
            .then((result) => {
                if (result.value) {
                    $.ajax({
                        url: "<?php echo e(url('admin/matches-delete')); ?>" + '/' + document_id,
                        type: "POST",
                        data: {
                            '_method': 'GET',
                            '_token': csrf_token
        ...
        $('body').on('click', '.score-match', function () {
            ...
            var document_id = $(this).data("id");
            $.ajax({
                url: "<?php echo e(url('admin/matches-score')); ?>",
                type: "POST",
                data: {
                    'id' : document_id,
                    '_token': csrf_token
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/conan/Music/hiu/resources/views/admin/matches/home.blade.php ENDPATH**/ ?>