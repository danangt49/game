        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="featured-game-thumb text-center">
                    ...
                    <p class="mt-3 mb-3">Download now at</p>
            ...
            <div class="col-lg-4 mb-500  wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                <div class="game-card">
                    <div class="game-card__thumb">
                        <a href="<?php echo e(url('game-pc/'.$data->slug.'')); ?>"><img src="<?php echo e(asset('public/asset/game/'.$data->picture )); ?>" alt="image"></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.website.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/conan/Music/hiu/resources/views/website/pc/game-pc.blade.php ENDPATH**/ ?>