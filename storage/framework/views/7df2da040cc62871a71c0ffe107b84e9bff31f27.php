            ...
            <div class="col-lg-8">
                ...
                <div id="blog" class="post-card style--two mb-40">
                    ...
                    <div class="post-card__content">
                        <h3 class="post-card__title mb-3"><a href="<?php echo e(url('article/'.$item->kategori.'/'.$item->slug.'')); ?>"><?php echo e($item->judul); ?></a></h3>
                        <p><?php echo Str::limit($item->konten,190); ?></p>
                        <a href="<?php echo e(url('article/'.$item->kategori.'/'.$item->slug.'')); ?>">Selengkapnya</a></p>
                    </div>
                </div>
                &nbsp;
                ...
                <div class="sidebar">
                        ...
                        <div class="small-post-slider">
                            ...
                            <div class="post-item">
                                ...
                                <div class="post-item__content">
                                    <h3><a href="<?php echo e(url('article/'.$item->kategori.'/'.$item->slug.'')); ?>"><?php echo e($item->judul); ?></a></h3>
                    ...
                    <div class="widget">
                        ...
                        <ul class="category-list">
                            ...
                            <li>
                                <a href="<?php echo e(url('article/'.$item->_slug.'')); ?>">
...
<?php echo $__env->make('layouts.website.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/conan/Music/hiu/resources/views/website/mobile/blog.blade.php ENDPATH**/ ?>