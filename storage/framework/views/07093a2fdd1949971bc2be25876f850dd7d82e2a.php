						...
						<div class="wrap">
							<div class="manage-menus">
								<form method="get" action="<?php echo e($currentUrl); ?>">
									...
									<?php echo Applib::select('menu', $menulist); ?>
									...
									<form id="nav-menu-meta" action="" class="nav-menu-meta" method="post" enctype="multipart/form-data">
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												...
												<li class="control-section accordion-section add-mod" id="add-mod">
													<h3 class="accordion-section-title hndle" tabindex="1"> Modul<span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="modullinkdiv" id="modullinkdiv">
																<table class="table  table-bordered " >
																	<?php echo Applib::menumodul(); ?>
...
<?php $__env->startSection('css'); ?>
	<link href="<?php echo e(asset('public/menu/style.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
...
<script type="text/javascript" src="<?php echo e(asset('public/menu/scripts.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/menu/scripts2.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/menu/menu.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/game/resources/views/admin/menu/menu.blade.php ENDPATH**/ ?>