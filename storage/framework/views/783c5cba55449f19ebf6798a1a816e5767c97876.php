    ...
    <div class="wrapper">
            ...
            <div class="<?php echo e(config('adminlte.classes_topnav_container', 'container')); ?>">
                <?php if(config('adminlte.logo_img_xl')): ?>
                    <a href="<?php echo e($dashboard_url); ?>" class="navbar-brand logo-switch">
                        <img src="<?php echo e(asset(config('adminlte.logo_img', 'public/vendor/adminlte/dist/img/AdminLTELogo.png'))); ?>" alt="<?php echo e(config('adminlte.logo_img_alt', 'AdminLTE')); ?>" class="<?php echo e(config('adminlte.logo_img_class', 'brand-image-xl')); ?> logo-xs">
                ...
                <?php else: ?>
                    <a href="<?php echo e($dashboard_url); ?>" class="navbar-brand <?php echo e(config('adminlte.classes_brand')); ?>">
                        <img src="<?php echo e(asset(config('adminlte.logo_img', 'public/vendor/adminlte/dist/img/AdminLTELogo.png'))); ?>" alt="<?php echo e(config('adminlte.logo_img_alt', 'AdminLTE')); ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <aside class="main-sidebar <?php echo e(config('adminlte.classes_sidebar', 'sidebar-dark-primary elevation-4')); ?>">
            ...
            <div class="sidebar">
                ...
                <!--    <div class="info">-->
                <!--        <a href="#" class="d-block"><strong><?php echo e(Auth::user()->name); ?> </strong></a>-->
                <!--    </div>-->
                <!--</div>-->
                <nav class="mt-2">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/game/vendor/jeroennoten/laravel-adminlte/src/../resources/views/page.blade.php ENDPATH**/ ?>