									...
									<form id="nav-menu-meta" action="" class="nav-menu-meta" method="post" enctype="multipart/form-data">
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												...
												{{-- <li class="control-section accordion-section add-prod" id="add-prod">
													<h3 class="accordion-section-title hndle" tabindex="1"> Produk<span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="produklinkdiv" id="produklinkdiv">
																<table class="table  table-bordered " >
																	{!! Applib::menuproduk() !!}
																</table>
...
@section('css')
	<link href="{{asset('public/menu/style.css')}}" rel="stylesheet">
@stop
...
<script type="text/javascript" src="{{ asset('public/menu/scripts.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/menu/scripts2.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/menu/menu.js') }}"></script>
@stop
