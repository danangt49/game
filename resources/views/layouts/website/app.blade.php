...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="header__bottom">
                <div class="container">
                    <nav class="navbar navbar-expand-xl align-items-center">
                        <a class="site-logo site-title" href="{{ $website }}"><img src="{{ asset('public/asset/img/'.$logo.'') }}" style="padding-left: 40px; width: 150px;" alt="{{$logo}}"><span class="logo-icon"><i class="flaticon-fire"></i></span></a>
        ...
        <footer class="footer-section bg_img" data-background="{{ asset('public/website/assets/images/elements/footer-01.png') }}">
            <div class="container">
                <div class="row footer-top mb-none-50">
                    <div class="col-lg-3 col-sm-7 mb-50">
                        <a href="{{ $website }}" class="logo d-flex align-items-center">
                            <img src="{{ asset('public/asset/img/'.$logo.'') }}" alt="logo" width="200px">
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-7 mb-50">
                        <div class="footer-widget">
                            ...
                            @php $link_menu = Applib::WebMenu(2); @endphp
                            @if($link_menu)
                    ...
                    <div class="col-lg-2 col-sm-7 mb-50">
                        <div class="footer-widget">
                            ...
                            @php $about_menu = Applib::WebMenu(3); @endphp
                            @if($about_menu)
                            <ul class="short-links">
                ...
                <div class="row footer-bottom align-items-center">
                    <div class="col-lg-7 col-md-6 text-md-left text-center">
                        <p class="copy-right-text">Copyright &copy; <script>document.write(new Date().getFullYear());</script> All Rights Reserved By <a href="{{$website}}">{{ $situs }}</a></p>
                    </div>
