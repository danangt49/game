...
<body>
                                ...
                                <a href="{{ url('/'.$item->category_slug.'') }}">
                                    <div class="single-landingpage text-center mb-30">
                                        <div class="landingpage-img mb-50">
                                            ...
                                            <!--    <img src="{{ asset('public/website/assets-landingpage/images/icon-pc.png') }}" width="70%" height="100%">-->
                                            <!--</div>-->
                                        </div>
    ...
    <footer class="footer">
        <div class="anticheat-logo">
            <img src="{{ asset('public/website/assets-landingpage/images/antc.png') }}" style="margin-bottom:20px;width: 30px">
            <img src="{{ asset('public/asset/img/'.$setting->logo) }}" style="margin-bottom:20px;width: 100px">
        </div>
    </footer>
</html>