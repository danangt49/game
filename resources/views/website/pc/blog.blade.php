            ...
            <div class="col-lg-8">
                ...
                <div id="blog" class="post-card style--two mb-40">
                    ...
                    <div class="post-card__content">
                        <h3 class="post-card__title mb-3"><a href="{{ url('news/'.$item->kategori.'/'.$item->slug.'') }}">{{$item->judul}}</a></h3>
                        <p>{!! Str::limit($item->konten,190) !!}</p>
                        <a href="{{ url('news/'.$item->kategori.'/'.$item->slug.'') }}">Selengkapnya</a></p>
                    </div>
                </div>
                &nbsp;
                @endforeach
                        ...
                        <div class="small-post-slider">
                            ...
                            <div class="post-item">
                                ...
                                <div class="post-item__content">
                                    <h3><a href="{{ url('news/'.$item->kategori.'/'.$item->slug.'') }}">{{$item->judul}}</a></h3>
