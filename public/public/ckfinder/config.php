...
$config['licenseName'] = 'http://localhost/halo';
$config['licenseKey']  = '*M?P-*1**-Y**D-*Y**-*Z**-X*7*-3**H';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].'/public/',
