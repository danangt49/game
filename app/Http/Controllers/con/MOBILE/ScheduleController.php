...
class ScheduleController extends Controller
{
    public function index(){
        ...
        $data['data1']			    = 'JADWAL';
        $data['all']                = Matches::orderBy('created_at', 'DESC')->get();
        $data['upcoming']           = Matches::where('status', 'upcoming')->orderBy('created_at', 'DESC')->get();
        $data['complete']           = Matches::where('status', 'complete')->orderBy('created_at', 'DESC')->get();
